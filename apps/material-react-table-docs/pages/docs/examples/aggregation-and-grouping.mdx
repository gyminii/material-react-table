...
<Head>
  <title>
    {'Aggregation and Grouping Example - Material React Table V4 Docs'}
  </title>
  <meta
    name="description"
...
Grouping and Aggregation features are usually hard to implement, but MRT (thanks to [TanStack Table](https://tanstack.com/table/v9/docs/framework/react/guide/grouping)) makes it easy. Once enabled, simply click the vertical ellipses (⋮) icon for the column you want to group by and select **Group by (column name)**.
