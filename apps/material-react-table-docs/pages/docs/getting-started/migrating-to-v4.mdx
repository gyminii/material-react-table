...
<Head>
  ...
  <meta
    name="description"
    content="Migrating to Material React Table V4 from V3: Material UI V9, TanStack Table V9, and the @mini_7/material-react-table package"
  />
</Head>

## Migrating to Material React Table V4 from V3

Material React Table V4 is the first release published as `@mini_7/material-react-table`, a community fork of [KevinVandy/material-react-table](https://github.com/KevinVandy/material-react-table).
...
<InstallCommand packagesString="@mini_7/material-react-table @mui/material@^9 @mui/icons-material@^9 @mui/x-date-pickers@^9" />
...
> The examples on this site still import from `material-react-table`. Their sandboxes alias that name to `@mini_7/material-react-table` in `package.json`, so the code samples work unchanged in either package name.
...
The `migrate-v3-to-v4` skill covers everything on this page, and the [`@mini_7/material-react-table-mcp`](https://github.com/gyminii/material-react-table/tree/v4/packages/material-react-table-mcp) server answers exact option lookups from your editor.

<br />

Is anything missing from this V4 migration guide? Open an issue or pull request on the [fork's GitHub repository](https://github.com/gyminii/material-react-table).
