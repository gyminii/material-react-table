...
The `migrate-v3-to-v4` skill covers everything on this page, and the [`@mini_7/material-react-table-mcp`](https://github.com/lminii/material-react-table/tree/v4/packages/material-react-table-mcp) server answers exact option lookups from your editor.
