...
To start using MaterialReactTable, you first need to [install](/docs/getting-started/install) `@mini_7/material-react-table` and the necessary Material UI V9 dependencies.
