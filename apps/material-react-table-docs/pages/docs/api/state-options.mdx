...
<Head>
  <title>{'State Options - Material React Table V4 Docs'}</title>
  <meta
    name="description"
...
> Many of the state options you can pass here are the same as the ones you can pass to the TanStack Table [useTable](https://tanstack.com/table/v9/docs/framework/react/reference/index/functions/useTable) hook.
