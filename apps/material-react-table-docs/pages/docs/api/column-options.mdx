...
<Head>
  <title>{'Column Options - Material React Table V4 Docs'}</title>
  <meta
    name="description"
...
> Many of the column options you can pass here are the same as the ones that you can pass to the [useTable](https://tanstack.com/table/v9/docs/guide/column-defs) ColumnDefs
