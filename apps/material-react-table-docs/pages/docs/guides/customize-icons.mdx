...
<Head>
  <title>Custom Icons Guide - Material React Table V4 Docs</title>
  <meta
    name="description"
...
To replace a default icon, specify the icon in the `icons` table option. You should get TS hints for the name of the icons you can replace, but you can also consult [this source file](https://github.com/lminii/material-react-table/blob/v4/packages/material-react-table/src/icons.ts) for a list of all the icons you can replace.
