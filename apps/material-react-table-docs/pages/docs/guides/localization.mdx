...
<Head>
  <title>{'Localization/i18n Guide - Material React Table V4 Docs'}</title>
  <meta
    name="description"
...
> If your language is not yet supported, please consider making a PR to add it to the library! See [here on GitHub](https://github.com/lminii/material-react-table/tree/v4/packages/material-react-table/src/locales).
...
For a full list of all available translation keys, see [here](https://github.com/lminii/material-react-table/blob/v4/packages/material-react-table/src/locales/en.ts).
