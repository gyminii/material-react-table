...
Material React Table is licensed under the [MIT License](https://github.com/gyminii/material-react-table/blob/v4/LICENSE) and is free to use in both personal and commercial projects.

### Features

✅ < 65kb gzipped - [Bundlephobia](https://bundlephobia.com/package/@mini_7/material-react-table)
...
If you would like to contribute code to the project, please read the [Contributing Guide](https://github.com/gyminii/material-react-table/blob/v4/CONTRIBUTING.md) to learn how to get started.

#### Support the Project

If you enjoy this library, please consider supporting the project by leaving a ⭐️ on the [fork's GitHub repository](https://github.com/gyminii/material-react-table) and on the [upstream repository](https://github.com/KevinVandy/material-react-table).

Nothing financial is required at all to support this library. The greatest help of all, actually, is to get involved in the project and community. Submitting [issues](https://github.com/gyminii/material-react-table/issues), [pull requests](https://github.com/gyminii/material-react-table/pulls), and helping others in the [Discord Server](https://discord.gg/5wqyRx6fnm) are all great ways to help out.
